...
# 热门精选
class HotChoices(TextChoices):
    """热门精选选项"""
    NO = 'False', '非热门'
    YES = 'True', '热门'

# 置顶
class TopChoices(TextChoices):
    """置顶选项"""
    NO = 'False', '不置顶'
    YES = 'True', '置顶'

# 是否限制
class ShowChoices(TextChoices):
    """显示状态选项"""
    NO = 'False', '隐藏'
    YES = 'True', '显示'
...
class Movie(models.Model):
    ...
    image_url = models.URLField(max_length=300,blank=True,verbose_name='图片链接')
    ...
    is_hot = models.BooleanField(choices=HotChoices.choices, default=False, verbose_name='是否热门')
    is_top = models.BooleanField(choices=TopChoices.choices, default=False, verbose_name='是否置顶')
    ...
    is_show = models.BooleanField(choices=ShowChoices.choices, default=True, verbose_name='是否显示')
    # 设置外键关联
